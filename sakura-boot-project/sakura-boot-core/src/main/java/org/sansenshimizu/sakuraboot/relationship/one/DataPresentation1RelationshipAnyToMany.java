 ...
 * relationship to another entity of type One To Many or Many To Many.
 *
 ...
 * @since      0.1.0
 */
public interface DataPresentation1RelationshipAnyToMany<
    I extends Comparable<? super I> & Serializable,
    R extends DataPresentation<?>> extends DataPresentation<I> {

    /**
     * The getter for the relational entities.
     *
