 ...
 * relationship to two others entities of type One To Many or Many To Many.
 *
 ...
 * @since       0.1.0
 */
public interface DataPresentation2RelationshipAnyToMany<
    I extends Comparable<? super I> & Serializable,
    R extends DataPresentation<?>, R2 extends DataPresentation<?>>
    extends DataPresentation1RelationshipAnyToMany<I, R> {

    /**
     * The getter for the second relational entities.
     *
     * @return The second relationships.
     */
    @Nullable
    Set<R2> getSecondRelationships();
}
