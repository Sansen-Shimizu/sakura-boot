 ...
 * @since       0.1.0
 */
public interface BasicDto2RelationshipAnyToMany<
    ...
    extends DataPresentation2RelationshipAnyToMany<I, R, R2>,
    BasicDto1RelationshipAnyToMany<I, R, I2> {

    /**
     * The getter for the second relational entities ID.
     *
     * @return The second relational entities ID.
     */
    @Nullable
    Set<I3> getSecondRelationshipsId();
}
