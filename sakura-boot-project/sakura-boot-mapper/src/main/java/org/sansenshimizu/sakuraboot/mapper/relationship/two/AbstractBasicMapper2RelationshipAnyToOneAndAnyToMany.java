 ...
 * to One and Many to One and One to Many and Many to Many.
 * <p>
 * To create a mapper that extends
 * {@link AbstractBasicMapper2RelationshipAnyToOneAndAnyToMany}, follow
 * these steps:
 * </p>
 * <p>
 ...
 *     extends AbstractBasicMapper2RelationshipAnyToOneAndAnyToMany&lt;//
 *         YourEntity, YourDto, YourRelationalEntity, YourRelationalDto,
 *         YourRelationalEntityIdType, YourSecondRelationalEntity,
 *         YourSecondRelationalDto, YourSecondRelationalEntityIdType&gt; {
 *
 ...
 *              {@link DataPresentation2RelationshipAnyToOneAndAnyToMany}.
...
/*@formatter:off*/
public abstract
    class AbstractBasicMapper2RelationshipAnyToOneAndAnyToMany<
    /*@formatter:on*/
    E extends DataPresentation2RelationshipAnyToOneAndAnyToMany<?, R, R2>,
    D extends DataPresentation2RelationshipAnyToOneAndAnyToMany<?, D2, D3>,
    ...
    protected Set<R2> secondRelationshipFromDto(final D dto) {
        ...
        if (dto instanceof final BasicDto2RelationshipAnyToOneAndAnyToMany<?, ?,
            ?, ?, ?> dtoRelationship) {
        ...
        return secondRelationshipFromDto(dto.getRelationships());
    }
    ...
    protected Set<I2> mapDtoSecondRelationshipWithId(final E entity) {
        ...
        final Set<R2> relationalEntities = entity.getRelationships();
    ...
    protected Set<D3> mapDtoSecondRelationshipWithEntity(final E entity) {
        ...
        if (relationalEntities != null
            ...
            return secondRelationshipToDtos(relationalEntities);
        }
        return Collections.emptySet();
    }
