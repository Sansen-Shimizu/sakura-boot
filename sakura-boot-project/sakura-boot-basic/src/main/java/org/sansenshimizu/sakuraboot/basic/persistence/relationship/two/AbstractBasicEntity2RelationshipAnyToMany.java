 ...
 * {@link AbstractBasicEntity2RelationshipAnyToMany}, follow these steps:
 * </p>
 * <p>
 * Extend the {@link AbstractBasicEntity2RelationshipAnyToMany} class:
 * </p>
 * <blockquote>
 *
 * <pre>
 ...
 *     extends AbstractBasicEntity2RelationshipAnyToMany&lt;YourIdType,
 ...
 *     })
 *     &#064;JoinTable(
 *         name = "second_join_table",
 *         joinColumns = @JoinColumn(name = "parent_id"),
 *         inverseJoinColumns = @JoinColumn(name = "second_relational_id"))
 *     &#064;Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
 *     private Set&lt;YourSecondRelationalEntity&gt; secondRelationships;
 *
 *     YourEntity() {}
 *
 ...
 * @author      Malcolm Rozé
 * @see         AbstractBasicEntity1RelationshipAnyToMany
 * @see         DataPresentation2RelationshipAnyToMany
 * @since       0.1.0
 */
@MappedSuperclass
@SuperBuilder(toBuilder = true)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public abstract class AbstractBasicEntity2RelationshipAnyToMany<
    I extends Comparable<? super I> & Serializable,
    R extends AbstractBasicEntity<?>, R2 extends AbstractBasicEntity<?>>
    extends AbstractBasicEntity1RelationshipAnyToMany<I, R>
    implements DataPresentation2RelationshipAnyToMany<I, R, R2> {

    @Serial
    private static final long serialVersionUID = -7728639802094174825L;
}
