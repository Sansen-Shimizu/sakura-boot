 ...
 * types any to One and any To Many.
 * This class can be used to make an entity relational to two other
 * {@link AbstractBasicEntity} of type ManyToOne and ManyToMany.
 ...
 * {@link AbstractBasicEntity2RelationshipAnyToOneAndAnyToMany}, follow these
 * steps:
 * </p>
 * <p>
 * Extend the {@link AbstractBasicEntity2RelationshipAnyToOneAndAnyToMany}
 * class:
 * </p>
 * <blockquote>
 *
 ...
 *     2RelationshipAnyToOneAndAnyToMany&lt;YourIdType,
 *         YourRelationalEntity, YourSecondRelationalEntity&gt; {
 *
 *     // For one Many to One and one Many to Many relationship
 *     &#064;Id
 ...
 *     // For one Many to One and one Many to Many relationship
 *
 *     // For one One to One and one Many to Many relationship
 *     &#064;Id
 *     &#064;GeneratedValue(strategy = GenerationType.IDENTITY)
 *     &#064;Column(nullable = false)
 *     private Long id;
 ...
 *         return list;
 *     }
 *     // Add your fields, getter method here ...
 * }
 * </pre>
 *
 * </blockquote>
...
public abstract class AbstractBasicEntity2RelationshipAnyToOneAndAnyToMany<
    I extends Comparable<? super I> & Serializable,
    R extends AbstractBasicEntity<?>, R2 extends AbstractBasicEntity<?>>
    extends AbstractBasicEntity1RelationshipAnyToOne<I, R>
    implements DataPresentation2RelationshipAnyToOneAndAnyToMany<I, R, R2> {

    @Serial
    private static final long serialVersionUID = -5645302071884587822L;
}
