...
IMPORTANT: For a production-ready application, remove the spring.jpa.hibernate.ddl-auto property.
...
TIP: An entity is equivalent to one table in the database.
...
IMPORTANT: Lombok can help reduce the boilerplate code but needs to be used carefully. see xref:lombok.adoc[]
