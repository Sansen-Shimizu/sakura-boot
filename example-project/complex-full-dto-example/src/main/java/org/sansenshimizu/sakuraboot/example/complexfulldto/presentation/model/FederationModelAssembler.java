...
import org.sansenshimizu.sakuraboot.example.complexfulldto.presentation.FederationController;
...
public class FederationModelAssembler
    ...
    @Override
    protected Function<FederationDto, FederationModel> instantiateModel() {
